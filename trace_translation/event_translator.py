...
class EventTranslator:
    def __init__(self, dataframe):
        self.df = dataframe
    def translate_power_cpu_idle(self, row):
    ...
    def translate_sched_switch(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_kmem_kmalloc(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_kmem_kfree(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        call_site = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_sched_waking(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_sched_wakeup(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        comm = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_rcu_utilization(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_syscall_exit_epoll_wait(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_kmem_cache_alloc(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        call_site = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_syscall_entry_ioctl(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_x86_irq_vectors_call_function_entry(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_x86_irq_vectors_call_function_exit(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        vector = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_kmem_cache_free(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        call_site = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_syscall_exit_ioctl(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ret = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_syscall_entry_splice(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_kmem_mm_page_alloc(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_syscall_exit_splice(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ret = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_writeback_mark_inode_dirty(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_writeback_dirty_inode_start(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        name = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_block_touch_buffer(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        ...
        return translation
    def translate_writeback_dirty_inode(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        name = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_block_dirty_buffer(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        dev = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_writeback_dirty_page(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        name = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_kmem_mm_page_free(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        contents = row['Contents'].split(', ')
        page = contents[0].split('=')[1] if len(contents) > 0 else 'unknown'
        ...
        return translation
    def translate_syscall_entry_sync_file_range(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_block_bio_remap(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        rwbs_translation = "read and write" if "rw" in rwbs else "read-only" if "r" in rwbs else "write-only"
        ...
        translation = (
            ...
            f"This operation, characterized by its {rwbs_translation} status, redirected I/O from sector {old_sector} "
            f"on device {old_dev} to the new location. This is crucial for optimizing I/O operations and managing device wear."
        )
        return translation
    def translate_kmem_kmalloc_node(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_sync_file_range(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_sched_stat_runtime(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_power_cpu_frequency(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        return translation
    def translate_sched_process_free(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        comm = row['Contents'].split(', ')[0].split('=')[1]
        tid = row['TID']
        ...
        return translation
    def translate_syscall_entry_sendmsg(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        flags_translation = "none" if flags == "0" else f"flags value {flags}"
        translation = (
            ...
            f"with {flags_translation}. This system call is typically used for sending messages through a socket."
        )
        return translation
    def translate_syscall_exit_sendmsg(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        return translation
    def translate_syscall_entry_close(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        return translation
    def translate_syscall_exit_close(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        return translation
    def translate_syscall_entry_epoll_wait(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        return translation
    def translate_sched_migrate_task(self, row):
        timestamp = row['Timestamp']
        ...
        return translation
    def translate_syscall_exit_recvmsg(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_shutdown(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_shutdown(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_newfstat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_newfstat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_mmap(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Mapping translation based on protection
        ...
        return translation
    def translate_syscall_exit_mmap(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_write(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_write(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_exit_group(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_sched_process_exit(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_wait4(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_rt_sigaction(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_rt_sigaction(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_rt_sigprocmask(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        translation = (
            f"At {timestamp}, the process {pid} (TID {tid}, priority {prio}) initiated a syscall on CPU {cpu_id} to {how_translation} signals. "
        ...
        return translation
    def translate_syscall_exit_rt_sigprocmask(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_wait4(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_sched_process_wait(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_unknown(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_read(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_read(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_lseek(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        translation = (
            ...
            f"to {offset} bytes {whence_translation}. This call is often used to reposition the read/write file offset, "
            f"facilitating operations such as file searching or data appending."
        )
        return translation
    def translate_syscall_exit_lseek(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_clone(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        flag_translation = "with child thread running in a new stack space" if newsp != '0x0' else "within the same stack space as the parent"
        ...
        translation = (
            ...
            f"This call attempts to create a new process or thread {flag_translation} {parent_tid_info} {child_tid_pointer}. "
        ...
        return translation
    def translate_sched_process_fork(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ...
        return translation
    def translate_sched_wakeup_new(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        comm = row['Contents'].split(', ')[0].split('=')[1]
        ...
        return translation
    def translate_syscall_exit_clone(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        ret = row['Contents'].split(', ')[0].split('=')[1]
        tid = row['TID']
        ...
        return translation
    def translate_syscall_entry_execve(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_sched_process_exec(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_execve(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_brk(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_brk(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        result_translation = f"resulting in a new program break location at address {ret}."
        if int(ret) == 0:
            result_translation = "but failed to change the program break location."

        translation = (
            f"At {timestamp}, the 'brk' system call concluded for process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id}. "
            f"The request {result_translation} The 'brk' system call adjusts the end of the data segment to the value specified by brk, "
            f"thereby managing the amount of memory allocated to the process's heap."
        )
        return translation
    def translate_syscall_entry_access(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        mode_translation = modes.get(mode, f"special mode {mode}")

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} initiated an 'access' system call to check permissions "
            f"for the file '{filename}'. The operation is attempting to verify the following access mode: {mode_translation}. "
        ...
        return translation
    def translate_syscall_exit_access(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_open(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        flags_translation = "Flags: " + flags  # Extend this to translate flags properly
        mode_translation = "Mode: " + mode  # Extend this to translate mode properly

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} initiated an 'open' system call to open the file '{filename}'. "
            f"The call attempts to open the file with {flags_translation} and {mode_translation}. "
            f"This system call is crucial for file operations, allowing the process to specify how the file should be accessed."
        )
        return translation
    def translate_syscall_exit_open(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if int(ret_code) >= 0:
            ...
            error_translation = "an unknown error occurred"
            if int(ret_code) == -1:
                error_translation = "due to insufficient permissions or the file does not exist"
            elif int(ret_code) == -2:
                error_translation = "because the path name is too long"
            access_result = f"failed {error_translation}"
        ...
        return translation
    def translate_syscall_entry_mprotect(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        prot_translation = prot_translations.get(prot, f"special mode {prot}")
        ...
        translation = (
            ...
            f"The requested protection level is set to '{prot_translation}'. This syscall is crucial for managing memory protection "
        ...
        return translation
    def translate_syscall_exit_mprotect(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if int(ret_code) == 0:
            result_translation = "successfully modified the memory protection settings."
        else:
            result_translation = f"failed with error code {ret_code}, indicating an issue with the parameters or permissions."

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} completed an 'mprotect' system call. "
            f"The attempt to change memory protection {result_translation} This operation, processed in the source file '{source}', "
        ...
        return translation
    def translate_syscall_exit_unknown(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_munmap(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_munmap(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_getpid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_getpid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_geteuid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_geteuid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return euid_translation
    def translate_syscall_entry_getppid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_getppid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_newstat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_newstat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_fcntl(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        command_translation = commands.get(cmd, f"Unknown command {cmd}")

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} initiated a 'fcntl' system call with file descriptor {fd}. "
            f"The command '{command_translation}' with argument {arg} is being processed. This system call is used for manipulating file descriptors and is "
        ...
        return translation
    def translate_syscall_exit_fcntl(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_pipe(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_pipe(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_dup2(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_dup2(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if int(ret_code) == -1:
            result_translation = "failed due to an error"
        else:
            result_translation = f"successfully duplicated to file descriptor {ret_code}"

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} completed a 'dup2' system call. "
            f"The attempt to duplicate the file descriptor {result_translation}. "
            f"Referenced source file: {source}."
        )
        return translation
    def translate_syscall_entry_chdir(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_chdir(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_getdents(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_getdents(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_faccessat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        translation = (
            ...
            f"This call checks if the file '{filename}' has '{mode_translation}' permissions. The directory file descriptor (dfd) is {dfd}. "
        ...
        return translation
    def translate_syscall_exit_faccessat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_getuid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_getuid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_getgid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_getgid(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_mkdir(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_mkdir(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_set_tid_address(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_set_tid_address(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_set_robust_list(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_set_robust_list(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Conditional extension of the translation based on the return value
        if ret == 0:
            translation += "The operation was successful, indicating that the robust list was set correctly without errors."
        else:
            translation += f"The operation failed with a return code of {ret}, indicating a potential error or invalid operation parameters."

        return translation
    def translate_syscall_entry_getrlimit(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Expanded resource translations based on typical resource IDs in Linux
        resource_map = {
        ...
        return translation
    def translate_syscall_exit_getrlimit(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_getcwd(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_getcwd(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_newlstat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_newlstat(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if ret == 0:
            translation = f"At {timestamp}, the 'newlstat' system call completed successfully for process {pid} on CPU {cpu_id}. The file's status information was stored at address {statbuf_address}."
        else:
            error_message = "File not found" if ret == -2 else "Unknown error"
            translation = f"At {timestamp}, the 'newlstat' system call by process {pid} failed with return code {ret} ({error_message}). No file status information was retrieved."

        translation += f" The operation was executed on thread ID {tid} with priority {prio}, sourced from {source}."
        return translation
    def translate_syscall_entry_futex(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_futex(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if int(ret) == 0:
            ret_translation = "The futex operation completed successfully."
        else:
            ret_translation = f"The futex operation failed with error code {ret}."
        ...
        return translation
    def translate_syscall_entry_pipe2(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_pipe2(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        translation = (
            ...
            f"{result_translation} "
            f"Source of this system call is located at {source}."
        )
        return translation
    def translate_syscall_entry_socket(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        family_translation = family_mapping.get(family, f"Unknown family ({family})")
        type_translation = type_mapping.get(type_, f"Unknown type ({type_})")

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} initiated a 'socket' system call. "
            f"The socket was created with family {family_translation}, type {type_translation}, and protocol {protocol}. "
            f"Source of this system call is located at {source}."
        )
        return translation
    def translate_syscall_exit_socket(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if ret == '0':
            ret_translation = "successfully created a new socket."
        else:
            ret_translation = f"encountered an error with code {ret} while attempting to create a new socket."

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} exited a 'socket' system call and {ret_translation} "
            f"Source of this system call is located at {source}."
        )
        return translation
    def translate_syscall_entry_connect(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_connect(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Generate different translations based on the return value
        if ret == '0':
        ...
        return translation
    def translate_syscall_entry_newuname(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_newuname(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_poll(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_poll(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Generating a detailed translation based on the return value
        if int(ret) >= 0:
            translation = (
        ...
        return translation
    def translate_syscall_entry_sendmmsg(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_sendmmsg(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_recvfrom(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_recvfrom(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_fadvise64(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Mapping advice values to human-readable translations
        advice_mapping = {
            '0': 'POSIX_FADV_NORMAL',
            '1': 'POSIX_FADV_RANDOM',
        ...
        advice_translation = advice_mapping.get(advice, 'Unknown advice')
        ...
        translation = (
            ...
            f"The advice provided was {advice_translation} ({advice}), which guides the kernel's behavior in managing the file's cache. "
            f"The source of this system call is located at {source}."
        )

        return translation
    def translate_syscall_exit_fadvise64(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # translation based on ret value
        if ret == '0':
            ret_translation = "The system call executed successfully."
        else:
            ret_translation = f"The system call failed with return value {ret}."
        ...
        return translation
    def translate_syscall_entry_getsockopt(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Level and optname mapping for better translation
        level_map = {
            '1': 'SOL_SOCKET'
        }
        optname_map = {
        ...
        level_translation = level_map.get(level, f"Unknown level ({level})")
        optname_translation = optname_map.get(optname, f"Unknown option ({optname})")

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} initiated a 'getsockopt' system call on file descriptor {fd}. "
            f"This call queries socket options at the {level_translation} level, specifically the {optname_translation} option. "
            f"The expected size of the option value to retrieve is {optlen} bytes. "
            f"Source of this system call is located at {source}."
        )

        return translation
    def translate_syscall_exit_getsockopt(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        if ret == "0":
            result_translation = "successfully retrieved"
        else:
            result_translation = f"failed with error code {ret}"

        translation = (
            f"At {timestamp}, the process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} completed a 'getsockopt' system call. "
            f"The operation {result_translation}. The option value is stored at memory address {optval} with a length of {optlen} bytes. "
            f"Source of this system call is located at {source}."
        )

        return translation
    def translate_syscall_entry_sendto(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        flag_translation = "with flags" if flags != '0' else "with no flags"

        translation = (
            f"At {timestamp}, process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} initiated a 'sendto' system call. "
            f"This call attempts to send data from buffer at {buff} of length {length} bytes {flag_translation} {address_info}. "
            f"Source of this system call is located at {source}."
        )
        return translation
    def translate_syscall_exit_sendto(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_inotify_add_watch(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_inotify_add_watch(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        ret = data['ret']
        status_translation = "successfully" if ret == '0' else f"failed with error code {ret}"

        translation = (
            f"At {timestamp}, the 'inotify_add_watch' system call completed {status_translation}. "
            f"Process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} attempted to add a file or directory watch, which "
            f"{status_translation}. Source of this system call is located at {source}."
        )
        return translation
    def translate_syscall_entry_chmod(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_chmod(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_entry_statfs(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        return translation
    def translate_syscall_exit_statfs(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        translation = (
            f"At {timestamp}, the 'statfs' system call completed {status_translation}. "
            f"Process {pid} (TID {tid}, priority {prio}) on CPU {cpu_id} attempted to get file system statistics, which "
            f"{status_translation}. The buffer used for storing the statistics is located at {buf}. "
            f"Source of this system call is located at {source}."
        )
        return translation
    def translate_syscall_entry_flock(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        # Mapping of cmd values to human-readable translations
        cmd_map = {
        ...
        cmd_translation = cmd_map.get(cmd, f"unknown command ({cmd})")
        ...
        translation = (
            ...
            f"The command issued was {cmd_translation}. The source code location for this system call is {source}."
        )
        return translation
    def translate_syscall_exit_flock(self, row):
        timestamp = row['Timestamp']
        cpu_id = row['CPU']
        tid = row['TID']
        prio = row['Prio']
        ...
        translation = (
            f"At {timestamp}, the 'flock' system call completed {status_translation}. "
    ...
    def process_events(self, event_type):
        ...
        if event_type == 'power_cpu_idle':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_power_cpu_idle, axis=1)
        elif event_type == 'sched_switch':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_switch, axis=1)
        elif event_type == 'kmem_kmalloc':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_kmalloc, axis=1)
        elif event_type == 'kmem_kfree':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_kfree, axis=1)
        elif event_type == 'sched_waking':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_waking, axis=1)
        elif event_type == 'sched_wakeup':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_wakeup, axis=1)
        elif event_type == 'rcu_utilization':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_rcu_utilization, axis=1)
        elif event_type == 'syscall_exit_epoll_wait':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_epoll_wait,axis=1)
        elif event_type == 'kmem_cache_alloc':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_cache_alloc, axis=1)
        elif event_type == 'syscall_entry_ioctl':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_ioctl, axis=1)
        elif event_type == 'x86_irq_vectors_call_function_entry':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_x86_irq_vectors_call_function_entry, axis=1)
        elif event_type == 'x86_irq_vectors_call_function_exit':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(
                self.translate_x86_irq_vectors_call_function_exit, axis=1)
        elif event_type == 'kmem_cache_free':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_cache_free, axis=1)
        elif event_type == 'syscall_exit_ioctl':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_ioctl, axis=1)
        elif event_type == 'syscall_entry_splice':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_splice, axis=1)
        elif event_type == 'kmem_mm_page_alloc':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_mm_page_alloc, axis=1)
        elif event_type == 'writeback_mark_inode_dirty':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_writeback_mark_inode_dirty, axis=1)
        elif event_type == 'writeback_dirty_inode_start':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_writeback_dirty_inode_start, axis=1)
        elif event_type == 'block_touch_buffer':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_block_touch_buffer, axis=1)
        elif event_type == 'writeback_dirty_inode':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_writeback_dirty_inode, axis=1)
        elif event_type == 'block_dirty_buffer':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_block_dirty_buffer, axis=1)
        elif event_type == 'writeback_dirty_page':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_writeback_dirty_page, axis=1)
        elif event_type == 'kmem_mm_page_free':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_mm_page_free, axis=1)
        elif event_type == 'syscall_entry_sync_file_range':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_sync_file_range, axis=1)
        elif event_type == 'block_bio_remap':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_block_bio_remap, axis=1)
        elif event_type == 'kmem_kmalloc_node':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_kmem_kmalloc_node, axis=1)
        elif event_type == 'syscall_exit_sync_file_range':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_sync_file_range, axis=1)
        elif event_type == 'sched_stat_runtime':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_stat_runtime, axis=1)
        elif event_type == 'power_cpu_frequency':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_power_cpu_frequency, axis=1)
        elif event_type == 'sched_process_free':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_process_free, axis=1)
        elif event_type == 'syscall_entry_sendmsg':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_sendmsg, axis=1)
        elif event_type == 'syscall_exit_sendmsg':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_sendmsg, axis=1)
        elif event_type == 'syscall_entry_close':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_close, axis=1)
        elif event_type == 'syscall_exit_close':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_close, axis=1)
        elif event_type == 'syscall_entry_epoll_wait':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_epoll_wait, axis=1)
        elif event_type == 'sched_migrate_task':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_migrate_task, axis=1)
        elif event_type == 'syscall_exit_recvmsg':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_recvmsg, axis=1)
        elif event_type == 'syscall_entry_shutdown':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_shutdown, axis=1)
        elif event_type == 'syscall_exit_shutdown':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_shutdown, axis=1)
        elif event_type == 'syscall_entry_newfstat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_newfstat, axis=1)
        elif event_type == 'syscall_exit_newfstat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_newfstat, axis=1)
        elif event_type == 'syscall_entry_mmap':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_mmap, axis=1)
        elif event_type == 'syscall_exit_mmap':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_mmap, axis=1)
        elif event_type == 'syscall_entry_write':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_write, axis=1)
        elif event_type == 'syscall_exit_write':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_write, axis=1)
        elif event_type == 'syscall_entry_exit_group':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_exit_group, axis=1)
        elif event_type == 'sched_process_exit':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_process_exit, axis=1)
        elif event_type == 'syscall_exit_wait4':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_wait4, axis=1)
        elif event_type == 'syscall_entry_rt_sigaction':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_rt_sigaction, axis=1)
        elif event_type == 'syscall_exit_rt_sigaction':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_rt_sigaction, axis=1)
        elif event_type == 'syscall_entry_rt_sigprocmask':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_rt_sigprocmask, axis=1)
        elif event_type == 'syscall_exit_rt_sigprocmask':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_rt_sigprocmask, axis=1)
        elif event_type == 'syscall_entry_wait4':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_wait4, axis=1)
        elif event_type == 'sched_process_wait':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_process_wait, axis=1)
        elif event_type == 'syscall_entry_unknown':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_unknown, axis=1)
        elif event_type == 'syscall_entry_read':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_read, axis=1)
        elif event_type == 'syscall_exit_read':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_read, axis=1)
        elif event_type == 'syscall_entry_lseek':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_lseek, axis=1)
        elif event_type == 'syscall_exit_lseek':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_lseek, axis=1)
        elif event_type == 'syscall_entry_clone':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_clone, axis=1)
        elif event_type == 'sched_process_fork':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_process_fork, axis=1)
        elif event_type == 'sched_wakeup_new':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_wakeup_new, axis=1)
        elif event_type == 'syscall_exit_clone':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_clone, axis=1)
        elif event_type == 'syscall_entry_execve':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_execve, axis=1)
        elif event_type == 'sched_process_exec':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_sched_process_exec, axis=1)
        elif event_type == 'syscall_exit_execve':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_execve, axis=1)
        elif event_type == 'syscall_entry_brk':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_brk, axis=1)
        elif event_type == 'syscall_exit_brk':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_brk, axis=1)
        elif event_type == 'syscall_entry_access':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_access, axis=1)
        elif event_type == 'syscall_exit_access':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_access, axis=1)
        elif event_type == 'syscall_entry_open':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_open, axis=1)
        elif event_type == 'syscall_exit_open':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_open, axis=1)
        elif event_type == 'syscall_entry_mprotect':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_mprotect, axis=1)
        elif event_type == 'syscall_exit_mprotect':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_mprotect, axis=1)
        elif event_type == 'syscall_exit_unknown':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_unknown, axis=1)
        elif event_type == 'syscall_entry_munmap':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_munmap, axis=1)
        elif event_type == 'syscall_exit_munmap':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_munmap, axis=1)
        elif event_type == 'syscall_entry_getpid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getpid, axis=1)
        elif event_type == 'syscall_exit_getpid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getpid, axis=1)
        elif event_type == 'syscall_entry_geteuid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_geteuid, axis=1)
        elif event_type == 'syscall_exit_geteuid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_geteuid, axis=1)
        elif event_type == 'syscall_entry_getppid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getppid, axis=1)
        elif event_type == 'syscall_exit_getppid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getppid, axis=1)
        elif event_type == 'syscall_entry_newstat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_newstat, axis=1)
        elif event_type == 'syscall_exit_newstat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_newstat, axis=1)
        elif event_type == 'syscall_entry_fcntl':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_fcntl, axis=1)
        elif event_type == 'syscall_exit_fcntl':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_fcntl, axis=1)
        elif event_type == 'syscall_entry_pipe':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_pipe, axis=1)
        elif event_type == 'syscall_exit_pipe':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_pipe, axis=1)
        elif event_type == 'syscall_entry_dup2':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_dup2, axis=1)
        elif event_type == 'syscall_exit_dup2':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_dup2, axis=1)
        elif event_type == 'syscall_entry_chdir':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_chdir, axis=1)
        elif event_type == 'syscall_exit_chdir':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_chdir, axis=1)
        elif event_type == 'syscall_entry_getdents':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getdents, axis=1)
        elif event_type == 'syscall_exit_getdents':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getdents, axis=1)
        elif event_type == 'syscall_entry_faccessat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_faccessat, axis=1)
        elif event_type == 'syscall_exit_faccessat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_faccessat, axis=1)
        elif event_type == 'syscall_entry_getuid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getuid, axis=1)
        elif event_type == 'syscall_exit_getuid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getuid, axis=1)
        elif event_type == 'syscall_entry_getgid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getgid, axis=1)
        elif event_type == 'syscall_exit_getgid':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getgid, axis=1)
        elif event_type == 'syscall_entry_mkdir':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_mkdir, axis=1)
        elif event_type == 'syscall_exit_mkdir':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_mkdir, axis=1)
        elif event_type == 'syscall_entry_set_tid_address':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_set_tid_address, axis=1)
        elif event_type == 'syscall_exit_set_tid_address':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_set_tid_address, axis=1)
        elif event_type == 'syscall_entry_set_robust_list':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_set_robust_list, axis=1)
        elif event_type == 'syscall_exit_set_robust_list':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_set_robust_list, axis=1)
        elif event_type == 'syscall_entry_getrlimit':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getrlimit, axis=1)
        elif event_type == 'syscall_exit_getrlimit':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getrlimit, axis=1)
        elif event_type == 'syscall_entry_getcwd':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getcwd, axis=1)
        elif event_type == 'syscall_exit_getcwd':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getcwd, axis=1)
        elif event_type == 'syscall_entry_newlstat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_newlstat, axis=1)
        elif event_type == 'syscall_exit_newlstat':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_newlstat, axis=1)
        elif event_type == 'syscall_entry_futex':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_futex, axis=1)
        elif event_type == 'syscall_exit_futex':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_futex, axis=1)
        elif event_type == 'syscall_entry_pipe2':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_pipe2, axis=1)
        elif event_type == 'syscall_exit_pipe2':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_pipe2, axis=1)
        elif event_type == 'syscall_entry_socket':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_socket, axis=1)
        elif event_type == 'syscall_exit_socket':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_socket, axis=1)
        elif event_type == 'syscall_entry_connect':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_connect, axis=1)
        elif event_type == 'syscall_exit_connect':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_connect, axis=1)
        elif event_type == 'syscall_entry_newuname':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_newuname, axis=1)
        elif event_type == 'syscall_exit_newuname':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_newuname, axis=1)
        elif event_type == 'syscall_entry_poll':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_poll, axis=1)
        elif event_type == 'syscall_exit_poll':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_poll, axis=1)
        elif event_type == 'syscall_entry_sendmmsg':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_sendmmsg, axis=1)
        elif event_type == 'syscall_exit_sendmmsg':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_sendmmsg, axis=1)
        elif event_type == 'syscall_entry_recvfrom':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_recvfrom, axis=1)
        elif event_type == 'syscall_exit_recvfrom':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_recvfrom, axis=1)
        elif event_type == 'syscall_entry_fadvise64':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_fadvise64, axis=1)
        elif event_type == 'syscall_exit_fadvise64':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_fadvise64, axis=1)
        elif event_type == 'syscall_entry_getsockopt':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_getsockopt, axis=1)
        elif event_type == 'syscall_exit_getsockopt':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_getsockopt, axis=1)
        elif event_type == 'syscall_entry_sendto':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_sendto, axis=1)
        elif event_type == 'syscall_exit_sendto':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_sendto, axis=1)
        elif event_type == 'syscall_entry_inotify_add_watch':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_inotify_add_watch, axis=1)
        elif event_type == 'syscall_exit_inotify_add_watch':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_inotify_add_watch, axis=1)
        elif event_type == 'syscall_entry_chmod':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_chmod, axis=1)
        elif event_type == 'syscall_exit_chmod':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_chmod, axis=1)
        elif event_type == 'syscall_entry_statfs':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_statfs, axis=1)
        elif event_type == 'syscall_exit_statfs':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_statfs, axis=1)
        elif event_type == 'syscall_entry_flock':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_entry_flock, axis=1)
        elif event_type == 'syscall_exit_flock':
            self.df.loc[event_idx, 'Translation'] = self.df.loc[event_idx].apply(self.translate_syscall_exit_flock, axis=1)
        return self.df.loc[event_idx, 'Translation'].tolist()
